...
namespace DevOpsProject.Shared.Models.DTO.Drone
{
    ...
    public class BatchRemoveDronesResponse
    {
        ...
        public IReadOnlyCollection<string> RemovedDroneIds { get; set; } = new List<string>();
        public IReadOnlyCollection<string> NotInHiveDroneIds { get; set; } = new List<string>();
        public IReadOnlyCollection<BatchRemoveError> Errors { get; set; } = new List<BatchRemoveError>();
    }
